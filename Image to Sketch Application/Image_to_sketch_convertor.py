...
def sketch_callback():
    ...
    outputImage = Image.fromarray(sketch)
...
tk.Label(title_frame, text="IMAGE TO SKETCH CONVERTOR", font=("ariel 20 bold"), bg="white", fg="black").place(x=100, y=30)

import_button = tk.Button(title_frame, text="Import", bg="#000080", foreground="white", font=("ariel 12 bold"), pady=3,
                          padx=25, command=import_command)
import_button.place(x=1200, y=35)

save_button = tk.Button(title_frame, text="Save", bg="#000080", foreground="white", font=("ariel 12 bold"), pady=3,
                        padx=25, command=save_image)
...
brightness_slide = ttk.Scale(right_frame, from_=0, to=2, orient='horizontal', length=200, style="TScale",
...
contrast_slide = ttk.Scale(right_frame, from_=0, to=2, orient='horizontal', length=200, style="TScale",
...
sharpness_slide = ttk.Scale(right_frame, from_=0, to=2, orient='horizontal', length=200, style="TScale",
                            command=sharpness_callback)
...
colors_slide = ttk.Scale(right_frame, from_=0, to=2, orient='horizontal', length=200, style="TScale",
...
tk.Label(right_frame,
         ...
         bg="#66CDAA").place(y=105, x=30)

# Radiobuttons

radiobutton_style = ttk.Style()
radiobutton_style.configure("TRadiobutton", background="#66CDAA", font="poppin 13 bold")
yellow_button = ttk.Radiobutton(right_frame, text="Yellow Filter", value=1, style="TRadiobutton",
                                command=yellowbutton_function)
yellow_button.place(x=80, y=145)

purple_button = ttk.Radiobutton(right_frame, text="Purple Filter", value=2, style="TRadiobutton",
                                command=purplebutton_function)
purple_button.place(x=260, y=145)

aqua_button = ttk.Radiobutton(right_frame, text="Aqua Filter", value=3, style="TRadiobutton",
                              command=aquabutton_function)
aqua_button.place(x=440, y=145)

orange_button = ttk.Radiobutton(right_frame, text="Orange Filter", value=4, style="TRadiobutton",
                                command=orangebutton_function)
orange_button.place(x=80, y=195)

black_white_button = ttk.Radiobutton(right_frame, text="Pink Filter", value=5, style="TRadiobutton",
                                     command=pinkbutton_function)
...
tk.Label(right_frame,
         text="____________________________________________________________________________________________________________________________",
         bg="#66CDAA").place(y=235, x=30)


# Buttons
sketch_button = tk.Button(right_frame, text="Sketch", width=12, background="#FF4040", font="poppin 13 bold", bd=0,
                           command=sketch_callback)
sketch_button.place(x=360, y=285)

rotate_buttton = tk.Button(right_frame, text="Rotate", width=12, background="#E3CF57", font="poppin 13 bold", bd=0,
                           command=rotate_callback)
rotate_buttton.place(x=30, y=285)

flip_buttton = tk.Button(right_frame, text="Flip", width=12, background="#EE1289", font="poppin 13 bold", bd=0,
                         command=flip_callback)
flip_buttton.place(x=190, y=285)

#emboss_buttton = tk.Button(right_frame, text="Emboss", width=12, background="#FF4040", font="poppin 13 bold", bd=0,
                           #command=emboss_callback)
#emboss_buttton.place(x=360, y=285)

edgenhance_buttton = tk.Button(right_frame, text="EdgeEnhance", width=12, background="#FF6103", font="poppin 13 bold",
                               bd=0, command=edgeEnhance_callback)
edgenhance_buttton.place(x=520, y=285)

blur_buttton = tk.Button(right_frame, text="Blur", width=12, background="#76EE00", font="poppin 13 bold", bd=0,
                         command=blurr_callback)
blur_buttton.place(x=30, y=345)

crop_buttton = tk.Button(right_frame, text="Crop", width=12, background="#FF7256", font="poppin 13 bold", bd=0,
                         command=crop_callback)
crop_buttton.place(x=190, y=345)

rotate_buttton = tk.Button(right_frame, text="Resize", width=12, background="#DC143C", font="poppin 13 bold", bd=0,
                           command=resize_callback)
rotate_buttton.place(x=360, y=345)

smooth_buttton = tk.Button(right_frame, text="Smooth", width=12, background="#B23AEE", font="poppin 13 bold", bd=0,
                           command=smooth_callback)
smooth_buttton.place(x=520, y=345)

tk.Label(right_frame,
         text="____________________________________________________________________________________________________________________________",
         bg="#66CDAA").place(y=395, x=30)
