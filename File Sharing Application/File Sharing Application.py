...
def Send():
    ...
    def select_file():
        fielname=filedialog.askopenfilename(initialdir=os.getcwd(),title="Select Image File" ,
    ...
    Button(window,text="SEND",widt=8,height=1,font="arial 14 bold",bg="#fff",fg="#000",command=sender).place(x=300,y=150)
