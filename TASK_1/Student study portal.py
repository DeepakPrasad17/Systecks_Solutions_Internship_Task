...
def Showimage():
    ...
    ("JPG files", "*.jpg"), ("PNG file", "*.png"), ("All files", "*.txt")))
...
def Save():
    ...
    if (
            R1 == "" or N1 == "" or N2 == "" or N3 == "" or Y1 == "Please Select" or P1 == "" or D1 == "Select a Month" or D2 == "Select a Day" or D3 == "Select a Year" or Deg == "Please Select" or E1 == "" or A1 == ""):
...
# Top Frames
Label(root, text="Vishwaniketan Institute of Management Entrepreneurship and Engineering Technology", width=2, font="Arial 16 bold", fg="#C0392B", height=1,
      bg="white").pack(side=TOP, fill=X)
Label(root, text="Accredited “A+” by NAAC ", width=2, font="Montserrat 14 bold", fg="black", height=1,
      bg="white").pack(side=TOP, fill=X)
Label(root,
      text="Engineering | Architecture | Design | Incubation ",
      width=2, font="Montserrat 14 bold", fg="black", height=1, bg="white").pack(side=TOP, fill=X)
Label(root, text="By Deepak Prasad", width=2, font="Arial 16 bold", fg="black", height=1, bg="white").pack(side=TOP,
                                                                                                          fill=X)

Label(root, text="STUDENT REGISTRATION FORM", width=2, font="Montserrat 20 bold", fg="white", height=2,
      bg="#154360").pack(side=TOP, fill=X)
...
# Sudent Details
obj = LabelFrame(root, text="Student Details", bg="white", font="comicsansms 18 bold", bd=2, width=1150, height=500,
                 relief="groove", fg="#212F3C")
...
Label(root, text="AICTE ID", font="Montserrat 16 bold", fg="#212F3C", bg="white").place(x=95, y=655)
...
Year = Combobox(obj, values=['1st Year', '2nd Year', '3rd Year', '4th Year'], font="Montserrat 14", width=40,
                foreground="#424949", state='r')
Year.place(x=658, y=190)
Year.set("Please Select")

Degree = Combobox(obj, values=['B.Tech. in Computer Science and Engineering', 'B.Tech. in Data Science Engineering',
                               'B.Tech. in Data Science Engineering', 'B.Tech. in Information Technology',
                               ...
                               'B.Tech. in Computer Science and Engineering (IoT)', 'B.Tech. in Civil Engineering',
                               'B.Tech. in Mechanical Engineering', 'B.Tech. in Electrical Engineering',
                  ...
                  font="Montserrat 14", width=47, foreground="#424949", state='r')
...
DOB1 = Combobox(obj, values=['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September',
                             'October', 'November', 'December'], font="Montserrat 14", width=12, foreground="#424949",
                state='r')
...
DOB2 = Combobox(obj,
                ...
                font="Montserrat 14", width=12, foreground="#424949", state='r')
...
Gender = IntVar()
G1 = Radiobutton(obj, text="Male", font="Montserrat 14", variable=Gender, value=1, command=selection, fg="#212F3C",
                 bg="white")
G1.place(x=705, y=415)
G2 = Radiobutton(obj, text="Female", font="Montserrat 14", variable=Gender, value=2, command=selection, fg="#212F3C",
                 bg="white")
...
profile = (PhotoImage(file="logo.png"))
p = Label(f, bg="white", image=profile)
p.place(x=0, y=0)

# Buttons
Button(root, text="Upload your photo", width=16, font="Montserrat 14 bold", bg="white", command=Showimage).place(x=1270, y=490)
